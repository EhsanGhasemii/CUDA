...
// ================================================================================================
	...
	//		W_reald_shr[thr_batch * data_num * X_size * 13 + blockIdx.x * 13 + mat_col] += out_real[thr_batch * 169 + mat_col * 13 + count1] * s_reald[count1]; 
	//		W_reald_shr[thr_batch * data_num * X_size * 13 + blockIdx.x * 13 + mat_col] -= out_imag[thr_batch * 169 + mat_col * 13 + count1] * s_imagd[count1]; 
//
//			W_imagd_shr[thr_batch * data_num * X_size * 13 + blockIdx.x * 13 + mat_col] += out_real[thr_batch * 169 + mat_col * 13 + count1] * s_imagd[count1]; 
//			W_imagd_shr[thr_batch * data_num * X_size * 13 + blockIdx.x * 13 + mat_col] += out_imag[thr_batch * 169 + mat_col * 13 + count1] * s_reald[count1]; 
	...
	//		W_imagd[thr_batch*data_num*X_size+blockIdx.x] -= W_real_shr[thr_batch * 13 + count1]*y_n_reald[thr_batch*data_num*X_size+blockIdx.x+12+12*alpha_indx+count1]
	//													   - W_imag_shr[thr_batch * 13 + count1]*y_n_imagd[thr_batch*data_num*X_size+blockIdx.x+12+12*alpha_indx+count1];		
	//		W_reald[thr_batch*data_num*X_size+blockIdx.x] += W_real_shr[thr_batch * 13 + count1]*y_n_imagd[thr_batch*data_num*X_size+blockIdx.x+12+12*alpha_indx+count1]
	//													   + W_imag_shr[thr_batch * 13 + count1]*y_n_reald[thr_batch*data_num*X_size+blockIdx.x+12+12*alpha_indx+count1];	
		

			W_imag_temp -= W_real_shr[thr_batch * 13 + count1]*y_n_reald[thr_batch*data_num*X_size+blockIdx.x+12+12*alpha_indx+count1]
						 - W_imag_shr[thr_batch * 13 + count1]*y_n_imagd[thr_batch*data_num*X_size+blockIdx.x+12+12*alpha_indx+count1];		
			W_real_temp += W_real_shr[thr_batch * 13 + count1]*y_n_imagd[thr_batch*data_num*X_size+blockIdx.x+12+12*alpha_indx+count1]
						 + W_imag_shr[thr_batch * 13 + count1]*y_n_reald[thr_batch*data_num*X_size+blockIdx.x+12+12*alpha_indx+count1];	
