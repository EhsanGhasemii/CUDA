...
//	double* test_imag; 
	...
	std::cout << "\tPer each row: " << du2.count() / 1000.0 / num_iter / batch_size / data_num << " milisecond" << std::endl; 
	std::cout << "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%" << std::endl; 
...
*/
	std::cout << "gpu apc shape: " << gpu_apc.n_rows << " " << gpu_apc.n_cols << std::endl; 
	std::cout << "y_noisy2 shape: " << y_noisy2.n_rows << " " << y_noisy2.n_cols << std::endl; 
